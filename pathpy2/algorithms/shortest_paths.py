...
from pathpy2.classes import HigherOrderNetwork
from pathpy2.classes import Network
from pathpy2.classes import Paths
...
def distance_matrix(network, weighted=False):
    ...
    dist_matrix = _csg.floyd_warshall(
...
def _sp(paths):
    ...
    assert isinstance(paths, Paths), "paths must be an instance of Paths"
