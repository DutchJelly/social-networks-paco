...
def mean_degree(network, degree="degree"):
    ...
    """
    assert (
        degree is "degree" or degree is "indegree" or degree is "outdegree"
...
def molloy_reed_fraction(network, degree="degree"):
    ...
    """
    return degree_moment(network, k=2, degree=degree) / degree_moment(
        network, k=1, degree=degree
    )
