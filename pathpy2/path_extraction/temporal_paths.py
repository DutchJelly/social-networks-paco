...
from pathpy2 import DAG
from pathpy2.path_extraction import paths_from_dag
from pathpy2.utils import Log
from pathpy2.utils import Severity


def paths_from_temporal_network(
    tempnet, delta=1, max_length=sys.maxsize, max_subpath_length=sys.maxsize
):
    """
    Warning: This function is deprecated. Calls will be rerouted to to x.
...
def paths_from_temporal_network_single(
    tempnet, delta=1, max_length=sys.maxsize, max_subpath_length=sys.maxsize
):
    """
...
def sample_paths_from_temporal_network_dag(
    tempnet, delta=1, num_roots=1, max_subpath_length=None
):
    """
