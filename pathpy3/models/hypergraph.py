...
from pathpy3.models.classes import BaseHyperGraph
...
class HyperGraph(BaseHyperGraph):
    ...
    def __init__(
        self, uid: Optional[str] = None, multiedges: bool = False, **kwargs: Any
    ) -> None:
        ...
        self._edges: HyperEdgeCollection = HyperEdgeCollection(multiedges=multiedges)
    ...
    def add_edge(
        self,
        *edge: Union[str, tuple, list, Node, HyperEdge],
    ...
    def add_edges(
        self, *edges: Union[str, tuple, list, Node, HyperEdge], **kwargs: Any
    ) -> None:
    ...
    def remove_edge(
        self, *edge: Union[str, tuple, Node, HyperEdge], uid: Optional[str] = None
    ) -> None:
    ...
    def plot(
        ...
        for node, edges in self.incident_edges.items():
            ...
            for edge in edges:
                graph["nodelinks"].append({"node": node, "link": edge, "value": "1"})
