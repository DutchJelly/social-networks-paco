...
# Time-stamp: <Tue 2021-08-24 14:40 juergen>
#
...
from pathpy3.core.temporal import TemporalPathPyObject, _get_start_end
...
class TemporalNode(Node, TemporalPathPyObject):
    ...
    def __init__(
        self, *node: Union[str, PathPyObject], uid: Optional[str] = None, **kwargs: Any
    ) -> None:
    ...
    def summary(self) -> str:
        """Object summary."""
        summary = ["Observation periode:\t{} - {}".format(self.start, self.end)]
...
class TemporalEdge(Edge, TemporalPathPyObject):
    ...
    def summary(self) -> str:
        """Object summary."""
        summary = ["Observation period:\t{} - {}".format(self.start, self.end)]
...
class TemporalNetwork(BaseTemporalNetwork, Network):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        # initialize the base class
        super().__init__(uid=uid, directed=directed, multiedges=multiedges, **kwargs)
