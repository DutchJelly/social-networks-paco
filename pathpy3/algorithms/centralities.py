...
from pathpy3.algorithms import shortest_paths
...
from pathpy3.models.models import ABCHigherOrderNetwork

# pseudo load class for type checking
if TYPE_CHECKING:
    from pathpy3.core.api import PathCollection
    from pathpy3.models.api import Network
    from pathpy3.models.api import HigherOrderNetwork
...
def _bw_hon(self: HigherOrderNetwork, normalized: bool = False) -> Dict:
    ...
    from pathpy3.core.edge import Edge
    ...
    lengths: defaultdict = defaultdict(lambda: defaultdict(lambda: float("inf")))
...
def eigenvector_centrality(
    network: Network, weight: Union[str, bool, None] = None, **kwargs: Any
) -> dict:
