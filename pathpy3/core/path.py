...
from pathpy3.core.core import PathPyObject, PathPyPath, PathPyCollection
...
class Path(PathPyPath):
    ...
    def subpaths(
        ...
        return (
            [
                Path(
                    *[self.objects[key] for key in obj],
...
class PathCollection(PathPyCollection):
    ...
    def _(self, *args: Union[int, str, PathPyObject], **kwargs: Any) -> None:
        ...
        obj = self._default_class(*args, uid=uid, directed=self.directed, **kwargs)
    ...
    def _(self, *args: None, **kwargs: Any) -> None:
        ...
        obj = self._default_class(uid, uid=uid, directed=self.directed, **kwargs)
        super().add(obj, count=count, **kwargs)
