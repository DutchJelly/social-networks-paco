...
from pathpy3.io.pandas import (
    to_network,
    to_temporal_network,
    to_dataframe,
    add_attributes as aa,
)

from pathpy3.core.api import Node, NodeCollection
from pathpy3.core.api import Edge, EdgeCollection
...
def read_dataframe(
    filename: str, sep: str = ",", header: bool = True, names: Optional[list] = None
) -> pd.DataFrame:
...
def add_attributes(
    filename: str, network: Network, sep: str = ",", header: bool = True, **kwargs: Any
) -> None:
...
def read_network(
    ...
    **kwargs: Any,
    ...
    frame = read_dataframe(filename=filename, sep=sep, header=header, names=names)
...
def write_dataframe(
    frame: pd.DataFrame, path_or_buf: Any = None, **pdargs: Any
) -> None:
