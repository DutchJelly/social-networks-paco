...
from pathpy3.core.temporal import TemporalPathPyObject
from pathpy3.models.temporal_network import (
    TemporalNodeCollection,
...
def test_TemporalPathPyObject():
    ...
    t = TemporalPathPyObject(uid="t", timestamp="2021-01-01", duration="1 days")

    assert t.start == pd.Timestamp("2021-01-01")
    assert t.end == pd.Timestamp("2021-01-02")

    # create a basic temporal object with str duration
    t = TemporalPathPyObject(uid="t", timestamp="2021-01-01", duration=1, unit="D")
